...
setMethod("TOC", signature=c('numeric', 'numeric'), 
          definition = function(index, boolean, mask=NULL, nthres=NULL, thres=NULL, NAval=0, P=NA, Q=NA, progress=FALSE, units=NULL)  {
            tocd <- .TOCnosp(index, boolean, mask=mask, nthres=nthres, thres=thres, NAval=NAval, P=P, Q=Q, progress=progress)
            return(tocd)
          }
          )
